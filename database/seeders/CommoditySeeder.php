...
class CommoditySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $commoditiesInfo = [
            ...
            'Sala de juegos' => 'Descubre nuestro gimnasio exclusivo en el hotel, equipado con lo último en tecnología fitness para que cada entrenamiento sea una experiencia revitalizante. Desde entrenamientos personalizados hasta clases grupales dinámicas.',
